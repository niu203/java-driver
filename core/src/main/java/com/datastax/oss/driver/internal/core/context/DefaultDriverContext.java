...
public class DefaultDriverContext implements InternalDriverContext {
  ...
  private final LazyReference<Map<String, SpeculativeExecutionPolicy>>
      speculativeExecutionPoliciesRef =
          new LazyReference<>(
              ...
              cycleDetector);
  private final LazyReference<Map<String, TimestampGenerator>> timestampGeneratorsRef =
      new LazyReference<>("timestampGenerators", this::buildTimestampGenerators, cycleDetector);
  ...
  protected Map<String, TimestampGenerator> buildTimestampGenerators() {
    return Reflection.buildFromConfigProfiles(
        this,
        DefaultDriverOption.TIMESTAMP_GENERATOR,
  ...
  @Override
  public Map<String, TimestampGenerator> timestampGenerators() {
    return timestampGeneratorsRef.get();
  }
